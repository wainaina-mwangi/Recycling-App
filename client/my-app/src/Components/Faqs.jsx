...
import { ChevronDown, HelpCircle, Info, ShieldCheck, AlertTriangle,Truck} from "lucide-react";
...
const faqs = [
  ...
  },
  {
    ...
    answer: "We support plastics, glass, paper, metal, and e-waste. You can check guidelines in the ‘Tips’ section.",
    icon: <Info className="text-green-600 w-6 h-6" />,
  },
  {
    question: "What if no recycler picks my request?",
    answer: "You can resubmit after 12 hours or contact support directly for help.",
              ...
              <AnimatePresence initial={false}>
                {activeIndex === index && (
                  <motion.div
                    ...
                    className="px-5 pt-0 pb-4 text-gray-600 dark:text-gray-300 overflow-hidden"
                  >
                    {faq.answer}
                  </motion.div>
                )}
